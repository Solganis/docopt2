...
The sources live in the usage text, so the help documents itself. Wire them imperatively instead, and they
scatter across the code, where a help screen can only reach them through a second description you maintain
by hand.
